  ...
  categories: [
    {
      ...
      questions: [
        /* ───── FAZ 1: Temel Tercihler ───── */
        {
          ...
          condition: () => true,
          optionA: { label: 'İnsanlarla\n birebir çalışmak', emoji: '🤝', gradient: ['#FF6B6B', '#FF8E53'], tags: { people: 3, empathy: 2, social: 2, team: 1 } },
          optionB: { label: 'Bilgisayar/Makine\nbaşında çalışmak', emoji: '💻', gradient: ['#667eea', '#764ba2'], tags: { tech: 3, machine: 2, individual: 2, analytic: 1 } }
        },
        {
        ...
        },
        {
          ...
          optionB: { label: 'Teknolojiyi araç olarak\n kullanmak yeter', emoji: '📝', gradient: ['#2c3e50', '#3498db'], tags: { people: 1, creative: 1, field: 1 } }
        },
        {
        ...
        },
        {
          ...
          condition: () => true,
          optionA: { label: 'Sabit mesai,\n düzenli hayat', emoji: '⏰', gradient: ['#2c3e50', '#4ca1af'], tags: { stability: 2, structured: 2, discipline: 1 } },
          optionB: { label: 'Esnek saatler,\n değişken günler', emoji: '🌙', gradient: ['#6a11cb', '#2575fc'], tags: { creative: 1, adventure: 1, risk: 1, individual: 1 } }
        },
        {
          id: 'm22', phase: 3, text: 'Eğitim sürecin nasıl olsun?',
          condition: () => true,
          optionA: { label: 'Uzun eğitim, \n derin uzmanlık', emoji: '📚', gradient: ['#0f0c29', '#302b63'], tags: { discipline: 2, depth: 2, precision: 1, detail: 1 } },
          optionB: { label: 'Hızlı öğren, \n emen uygula', emoji: '⚡', gradient: ['#e65c00', '#F9D423'], tags: { tech: 1, innovation: 1, courage: 1, risk: 1 } }
        },
        {
        ...
        },
        {
          ...
          condition: () => true,
          optionA: { label: 'Sahne önünde,\n tanınan biri', emoji: '🎤', gradient: ['#f12711', '#f5af19'], tags: { social: 3, courage: 2, leadership: 1, art: 1 } },
          optionB: { label: 'Perde arkasında\n çalışan beyin', emoji: '🧠', gradient: ['#667eea', '#764ba2'], tags: { individual: 2, depth: 2, analytic: 1, focus: 1 } }
        },
        {
    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          optionB: { label: 'Küçük ama etkili\n bir start-up', emoji: '💡', gradient: ['#f6d365', '#fda085'], tags: { freedom: 2, creativity: 2, speed: 1, fun: 1 } }
        },
        {
        ...
        },
        {
          ...
          condition: () => true,
          optionA: { label: 'Türk şirketinde\n çalışmak', emoji: '🇹🇷', gradient: ['#E30A17', '#FFFFFF'], tags: { local: 3, community: 2, stability: 1 } },
          optionB: { label: 'Uluslararası şirkette\n çalışmak', emoji: '🌎', gradient: ['#4834d4', '#686de0'], tags: { global: 3, scale: 1, accessible: 1 } }
        },
        {
          id: 's9', phase: 2, text: 'Marka değeri mi misyon mu?',
          condition: () => true,
          optionA: { label: 'Herkesin tanıdığı\n dev bir marka', emoji: '⭐', gradient: ['#0f0c29', '#302b63'], tags: { brand: 3, scale: 2, premium: 1 } },
          optionB: { label: 'Dünyayı değiştiren\n bir vizyon', emoji: '🔮', gradient: ['#6a11cb', '#2575fc'], tags: { mission: 2, future: 2, innovation: 1 } }
        },
        {
